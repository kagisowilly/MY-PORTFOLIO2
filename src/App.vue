<template>
  ...
  <footer class="page-footer font-small teal pt-2 bg-dark">
    <div class="container text-center text-md-left">
      ...
      <!-- Copyright -->
      <div class="footer-copyright text-center mb-0 py-1 text-muted h5">
        ©2021 Copyright: Kagiso Mphayi
      </div>
      <!-- Copyright -->
    </div>
  </footer>
